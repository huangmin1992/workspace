  ...
  newsPlay.prototype={
    ...
    init:function(){//初始化
      ...
      $('.news-animate').on('mouseenter',function(){
        ...
        $(this).find('.news-txt-info').css({'color':'#FFEB3B'})
      })
      $('.news-animate').on('mouseleave',function(){
        ...
        $(this).find('.news-txt-info').css({'color':'#fff'})
      })
      //左点击
...
$('.news-right>ul>li').on('click',function(){
  var _this = this;
  $(this).addClass('active').siblings('li').removeClass('active');
  $(this).find('.news-info').animate({height:93,paddingTop:5,paddingBottom:5},300);
